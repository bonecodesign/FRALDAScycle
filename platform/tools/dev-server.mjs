...
function resolveRequest(pathname) {
  ...
  if (surface === "admin" && ["/admin/users", "/admin/roles", "/admin/ads", "/admin/operations", "/admin/finance", "/admin/logistics", "/admin/reports", "/admin/data", "/admin/forecast", "/admin/alerts", "/admin/infrastructure"].includes(pathname)) {
